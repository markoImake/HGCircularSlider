...
open class CircularSlider: UIControl {
    ...
    */
    ...
    override public init(frame: CGRect) {
        ...
        setup()
//        NotificationCenter.default.addObserver(self, selector: #selector(self.methodOfReceivedNotification(notification:)), name: Notification.Name("valueChange"), object: nil)
    }
    ...
    */
    ...
    open var startPointValue: CGFloat = 0.0 {
        didSet {
            ...
            NotificationCenter.default.post(name: Notification.Name("valueChange"), object: nil, userInfo: ["startPointChanged":"\(startPointValue)"])
        }
    }
